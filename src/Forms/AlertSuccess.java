...
public class AlertSuccess extends javax.swing.JDialog {
    ...
    public AlertSuccess(java.awt.Frame parent, boolean modal) {
        ...
        changeAlert(AlertSuccessTitle, AlertSuccessMessage);
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-ok-50.png"))); // NOI18N
    ...
    public static String AlertSuccessMessage = "";
    ...
    public void changeAlert(String title, String message) {
        jLabel1.setText(AlertSuccessTitle);
        jLabel2.setText(AlertSuccessMessage);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlertSuccess(null, true).setVisible(true);
            }
        });
    }
